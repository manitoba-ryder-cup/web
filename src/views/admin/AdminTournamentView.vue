...
import { formatCourseTeeTime, utcToEventInput, eventInputToUtc } from '@/lib/teeTime'
          ...
          <BaseTabs :tabs="formats" v-slot="{ tab }">
            <div class="px-4">
              <div class="overflow-hidden rounded-md border border-mrc-line bg-mrc-surface shadow">
                ...
                >
                  <div class="min-w-0">
                    <p class="font-semibold tabular-nums">{{ formatCourseTeeTime(m.tee_time, m.tee_time_local) }}</p>
