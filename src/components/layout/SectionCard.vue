...
// A titled card: the section label lives in the box's own header band, so heading and
// content read as one object — no floating divider clashing with the border below it.
